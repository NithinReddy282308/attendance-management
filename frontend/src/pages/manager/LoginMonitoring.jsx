                ...
                {loginHistory.length > 0 ? (
                  loginHistory.map((record, index) => (
                    <tr key={index}>
                      ...
                      <td className="py-4 px-2 align-top break-all text-sm font-mono">
                        {Array.isArray(record.ipAddress)
                          ? record.ipAddress.join(", ")
                          : record.ipAddress}
                      </td>
                      ...
                      <td className="py-4 px-2 align-top">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">{getDeviceLabel(record.device)}</span>
                        </div>
                      </td>

                      {/* Browser */}
                      <td className="py-4 px-2 align-top text-sm">
                        {record.browser}
                      </td>
